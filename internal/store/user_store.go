...
type UserStore interface {
	...
	GetUserToken(scope, plaintTextPassword string) (*User, error)
}
...
func (s *PostgresUserStore) GetUserToken(scope, plaintTextPassword string) (*User, error) {
	tokenHash := sha256.Sum256([]byte(plaintTextPassword))
